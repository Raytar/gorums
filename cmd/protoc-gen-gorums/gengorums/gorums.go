...
func GenerateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	genStrictOrderingMethods(servicesData{g, file.Services}, strictOrderingCallTypes...)
	g.P()
}
...
func genGorumsMethods(data servicesData, methodOptions ...*protoimpl.ExtensionInfo) {
	...
	for _, service := range data.Services {
		for _, method := range service.Methods {
			// skip all strict ordering methods.
			// they will be generated by genStrictOrderingMethods
...
func genStrictOrderingMethods(data servicesData, methodOptions ...*protoimpl.ExtensionInfo) {
	g := data.GenFile
	for _, service := range data.Services {
		for _, method := range service.Methods {
...
func hasStrictOrderingOption(method *protogen.Method, methodOptions ...*protoimpl.ExtensionInfo) bool {
	for _, option := range methodOptions {
		if strictOrderingTypeCheckers[option](method) {
			return true
		}
	}
	return false
